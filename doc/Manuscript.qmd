...
Capture-recapture sampling was conducted according to Pollock's [@pollock1982] robust design. Under the robust design, three primary survey periods occurred each summer from 2014 to 2018, each consisting of three consecutive survey days (secondary periods).
