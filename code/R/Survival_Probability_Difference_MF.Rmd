...
difference_plot <- ggplot(time_summaries_df, aes(x = primary_period, y = mean)) +
  ...
  labs(
    title = "Difference in Survival Probabilities (M - F) Between Primary Periods",
    x = "Primary Period",
...
ggsave("/Users/johnimperato/Desktop/Mossy-Pond_companion/difference_in_survival_probabilities.png", 
       plot = difference_plot, width = 10, height = 6, dpi = 300)
```
